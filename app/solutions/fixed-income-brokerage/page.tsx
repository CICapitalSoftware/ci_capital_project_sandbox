...
export default function SolutionPage() {
  const title = "Fixed Income Brokerage";
  const description = "CI Capital's Fixed Income Brokerage provides institutional and corporate clients with access to debt capital markets, including government and corporate bonds, sukuk, and structured products. We offer competitive pricing, deep liquidity, and expert market insights.";
  const stat1 = "EGP 30B+";
  const stat1Label = "Annual Fixed Income Volume";
  const stat2 = "50+";
  const stat2Label = "Institutional Clients";
