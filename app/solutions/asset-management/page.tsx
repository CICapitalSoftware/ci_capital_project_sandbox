...
export default function SolutionPage() {
  ...
  const description = "CI Capital's Asset Management division is Egypt's largest asset manager, with EGP 153.4bn+ in assets under management. We offer institutional-grade investment solutions across equities, fixed income, and alternative investments, delivering superior risk-adjusted returns for our clients.";
  const stat1 = "EGP 153.4B+";
  const stat1Label = "Assets Under Management";
  const stat2 = "28%";
  const stat2Label = "YoY Growth";
