...
export default function SolutionPage() {
  const title = "Microfinance";
  const description = "CI Capital's microfinance arm provides accessible financial services to underserved communities and small businesses across Egypt. With a network of 220+ branches, we empower entrepreneurs and micro-enterprises through tailored credit solutions and financial inclusion programs.";
  const stat1 = "220+";
  const stat1Label = "Branches Nationwide";
  const stat2 = "117,000+";
